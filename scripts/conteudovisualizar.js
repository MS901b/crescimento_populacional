	var codigo_do_software = "populacoes";
	var nome_do_software = "Crescimento populacional";
	...
	var FichaTecnica = $H({
	    ...
	    sinopse: {
	        titulo: 'Sinopse',
	        conteudo: 'Neste software o aluno vai explorar numérica e graficamente dois modelos matemáticos para descrever o crescimento populacional de seres vivos, o de Malthus e o de Verhulst.'
	    },
	    conteudos: {
	        titulo: 'Conteúdo',
	        conteudo: 'Progressão geométrica; Função exponencial; Crescimento populacional; Modelo de Malthus e Modelo de Verhulst.'
	    },
	    objetivos: {
	        titulo: 'Objetivos',
	        conteudo: '1. Estudar dois modelos de crescimento populacional;2.  Explorar o crescimento exponencial de uma população – o modelo de Malthus; 3. Explorar o crescimento populacional com restrições – o modelo de Verhulst; 4 Fazer análise de gráficos.'
	    },
	    duracao: {
	        titulo: 'Duração',
